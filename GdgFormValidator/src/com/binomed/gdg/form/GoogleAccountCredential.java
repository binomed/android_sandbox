...
public final class GoogleAccountCredential implements HttpRequestInitializer {
	...
	private static final String TAG = "GoogleAccountCredential";
	 ...
	 */
	private GoogleAccountCredential(Context context, String scope, String token) {
	 ...
	 * @return new instance
	 */
	public static GoogleAccountCredential usingOAuth2(String token, Context context, String... scopes) {
		Preconditions.checkArgument(scopes.length != 0);
		String scope = "oauth2:" + Joiner.on(' ').join(scopes);
		return new GoogleAccountCredential(context, scope, token);
	}

	/** Sets the audience scope to use with Google Cloud Endpoints. */
	public static GoogleAccountCredential usingAudience(Context context, String audience, String token) {
	...
	/**
	 * Sets the selected Google account name (e-mail address), for example {@code "johndoe@gmail.com"} , or {@code null} for none.
	 */
	...
	/**
	 * Returns the selected Google account name (e-mail address), for example {@code "johndoe@gmail.com"}, or {@code null} for none.
	 */
	...
	// return AccountPicker.newChooseAccountIntent(account, null, new String[] { GoogleAccountManager.ACCOUNT_TYPE }, true, null, null, null, null);
	// }
