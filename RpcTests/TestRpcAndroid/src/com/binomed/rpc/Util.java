...
public class Util {
	 ...
	 */
	private static final String SHARED_PREFS = "appengineconnected".toUpperCase(Locale.ENGLISH) + "_PREFS";
	...
	public static void generateNotification(Context context, String message) {
		...
		notification.setLatestEventInfo(context, "C2DM Example", message, PendingIntent.getActivity(context, 0, null, PendingIntent.FLAG_CANCEL_CURRENT));
	...
	/**
	 * Returns a debug url, or null. To set the url, create a file {@code assets/debugging_prefs.properties} with a line of the form 'url=http:/<ip address>:<port>'. A numeric IP address may be required in situations where the device or emulator will not be able to resolve the hostname for the dev
	 * mode server.
	 */
